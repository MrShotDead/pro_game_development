# yellow_spaceship_img = pygame.image.load("C:/Users/OG_Da/Desktop/JetLearn/Pro Game Development/images/spaceship_yellow.png")
# red_spaceship_img = pygame.image.load("C:/Users/OG_Da/Desktop/JetLearn/Pro Game Development/images/spaceship_red.png")
...
# space = pygame.transform.scale(pygame.image.load("C:/Users/OG_Da/Desktop/JetLearn/Pro Game Development/images/space.png"), (WIDTH, HEIGHT))
...
yellow_spaceship_img = pygame.image.load("C:/Users/win/Desktop/JetLearn/Pro_Game_Development/Images/spaceship_yellow.png")
red_spaceship_img = pygame.image.load("C:/Users/win/Desktop/JetLearn/Pro_Game_Development/Images/spaceship_red.png")

yellow_spaceship = pygame.transform.rotate(pygame.transform.scale(yellow_spaceship_img, (spaceship_width, spaceship_height)), 90)
red_spaceship = pygame.transform.rotate(pygame.transform.scale(red_spaceship_img, (spaceship_width, spaceship_height)), 270)

space = pygame.transform.scale(pygame.image.load("C:/Users/win/Desktop/JetLearn/Pro_Game_Development/Images/background.png"), (WIDTH, HEIGHT))
...
def draw_winner(text, red_health, yellow_health):
    ...
    other_font = pygame.font.SysFont("Ariel", 30)
    other_text = other_font.render("Yellow Health: "+ str(yellow_health) + " " + "Red Health: "+str(red_health), 1, White)
    screen.blit(draw_text, (WIDTH / 2 - draw_text.get_width() / 2,
                             HEIGHT / 2 - draw_text.get_height() / 2))
    screen.blit(other_text, (WIDTH / 2 - other_text.get_width() / 2, HEIGHT / 2 - draw_text.get_height() / 2))
